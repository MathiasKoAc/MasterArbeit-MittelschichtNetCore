...
{
    public class MqttConnectAllAsync : IMqttConnector
    {
        ...
        public MqttConnectAllAsync(IServerConfig serverConfig, IApplicationLifetime applicationLifttime)
        {
            Start(serverConfig);
        ...
        private void WorkReceiverQueueAndCall()
        {
            while (isActive)
            {
                ...
                if (ListTopicReceiver != null)
                {
                    ...
                    {
                        Task.Run(() => receiver.OnReceivedMessage(e.Topic, e.Message));
                    }
                }
            }
        }
